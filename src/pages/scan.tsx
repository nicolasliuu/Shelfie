...
const Scanner: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#897DB1] to-[#323344]">
        <div className="container flex flex-col items-center justify-center px-4 py-3 ">
          <h1 className="text-5xl font-extrabold text-[#1B1D45] sm:text-[5rem] text-center mb-5">
            I&apos;m <span className="text-white">Shelfie</span>, your personal <br></br> smart fridge assistant.
          </h1>
          <InputInfo></InputInfo>
